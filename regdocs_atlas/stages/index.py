...
from ..embeddings import EmbeddingStore, embedding_plan, generate_embeddings
    ...
    *,
    ...
    for chunk, prov in iter_pairs(normalized_dir):
        ...
        if profile == "hybrid":
            ...
            content_vector = embedding_store.vector(
                str(chunk["id"]),
        ...
        doc = map_document(chunk, prov, profile=profile, content_vector=content_vector)
