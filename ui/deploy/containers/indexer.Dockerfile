...
COPY tools/publish_hybrid_index.py tools/publish_regulatory_records.py tools/prune_intelligence_cache.py tools/run_cloud_indexer.py tools/run_cloud_intelligence.py ./tools/
